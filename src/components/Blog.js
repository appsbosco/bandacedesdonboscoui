          ...
          <article className="flex flex-col items-start justify-between shadow-sm rounded-2xl bg-slate-50 shadow-sky-100/50 ring-1 ring-slate-100">
            ...
            <div className="relative flex flex-col flex-1 px-5 pt-8 pb-10 group xl:px-7">
              ...
              <div className="flex-1">
                ...
                <p className="mt-3.5 text-md leading-7 text-slate-700 line-clamp-3">
                  ¡Nos fuimos a La Cueva! 🏟️ Les mostramos un poco de lo que fue nuestra
                  presentación en el partido entre el Deportivo Saprissa y Club Sport Herediano.
                  ¡Sigamos haciendo bulla contra la violencia! 🎶
                </p>
              </div>
              <div className="flex items-center gap-3 mt-8 text-sm text-slate-500">
                <span className="flex items-center gap-1.5">
                  ...
                  <time dateTime="2023-03-19">Abril 23, 2023</time>
                </span>
              </div>
            </div>
          </article>
          ...
          <article className="flex flex-col items-start justify-between shadow-sm rounded-2xl bg-slate-50 shadow-sky-100/50 ring-1 ring-slate-100">
            ...
            <div className="relative flex flex-col flex-1 px-5 pt-8 pb-10 group xl:px-7">
              ...
              <div className="flex-1">
                ...
                <p className="mt-3.5 text-md leading-7 text-slate-700 line-clamp-3">
                  ¡Así se vivió el clásico nacional con la BCDB! ¡Muchas gracias Star Cars por esta
                  invitación! 🫶🏻⚽️
                </p>
              </div>
              <div className="flex items-center gap-3 mt-8 text-sm text-slate-500">
                <span className="flex items-center gap-1.5">
                  ...
                  <time dateTime="2023-03-24">Abril 2, 2023</time>
                </span>
              </div>
            </div>
          </article>
