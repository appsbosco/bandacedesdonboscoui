...
import cover from "../assets/images/cover-gb.webp";
          ...
          <div>
            <h2 className="text-4xl font-semibold font-display text-slate-900 sm:text-5xl">
              ...
              <span className="relative whitespace-nowrap">
                ...
                <span className="relative text-sky-700"> {t("values.highlight")} </span>
              </span>
            </h2>
          </div>
          <div>
            <p className="text-lg leading-8 text-slate-700">{t("values.description")}</p>
          </div>
        </div>
                  ...
                  <div className="relative flex space-x-7">
                    ...
                    <div>
                      <h3 className="text-xl font-medium font-display text-slate-900">
                        {t("values.friendship_title")}
                      </h3>
                      <p className="mt-2.5 text-base text-slate-700">
                        {t("values.friendship_text")}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <li>
                <div className="relative pb-24 lg:pb-20">
                  ...
                  <div className="relative flex space-x-7">
                    ...
                    <div>
                      <h3 className="text-xl font-medium font-display text-slate-900">
                        {t("values.passion_title")}
                      </h3>
                      <p className="mt-2.5 text-base text-slate-700">{t("values.passion_text")}</p>
                    </div>
                  </div>
                </div>
              </li>
              ...
              <li>
                <div className="relative">
                  <div className="relative flex space-x-7">
                    ...
                    <div>
                      <h3 className="text-xl font-medium font-display text-slate-900">
                        {t("values.family_title")}
                      </h3>
                      <p className="mt-2.5 text-base text-slate-700">{t("values.family_text")}</p>
                    </div>
                  </div>
                </div>
              </li>
