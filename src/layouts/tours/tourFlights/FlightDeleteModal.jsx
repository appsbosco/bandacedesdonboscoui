...
/**
 * FlightDeleteModal — confirmar eliminación de un vuelo.
 */

export default function FlightDeleteModal({ flight, onConfirm, onCancel, loading }) {
    ...
    >
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden">
        <div className="px-6 pt-6 pb-4 border-b border-slate-100">
          <h3 className="text-base font-bold text-slate-900">Eliminar vuelo</h3>
          ...
          <div className="bg-gray-50 rounded-2xl p-4 space-y-1">
            ...
            {flight.passengerCount > 0 && (
              <p className="text-xs text-amber-600 font-medium mt-1.5">
                ⚠️ Este vuelo tiene {flight.passengerCount} pasajero{flight.passengerCount !== 1 ? "s" : ""} asignado{flight.passengerCount !== 1 ? "s" : ""}.
              </p>
            )}
          </div>
