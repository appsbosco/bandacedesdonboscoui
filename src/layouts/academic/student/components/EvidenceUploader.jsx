...
import { uploadEvidenceToCloudinary, validateEvidenceFile } from "utils/uploadEvidenceToCloudinary";
  ...
  return (
    <div className="w-full">
      ...
      {state === "idle" && (
        <div
          className={`
            border-2 border-dashed rounded-xl p-4 text-center cursor-pointer transition-colors sm:p-5
            ${
              dragOver
      ...
      {state === "uploading" && (
        <div className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
          <div className="flex min-w-0 items-center gap-3 mb-3">
            ...
            <p className="min-w-0 truncate text-sm text-gray-700">{fileName}</p>
          </div>
        ...
        <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-3 sm:p-4">
          {preview ? (
            ...
            <div className="flex min-w-0 items-center gap-2 mb-2">
              ...
              <span className="min-w-0 truncate text-sm text-emerald-700">{fileName}</span>
            </div>
          )}
