      ...
      <table className="min-w-full text-sm">
        <thead>
          <tr className="bg-gray-50 border-b border-gray-200">
            ...
            {!readOnly && (
              <th className="px-4 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide whitespace-nowrap text-right">
                Acciones
              </th>
            )}
          </tr>
            ...
            return (
              <tr key={ev.id} className="bg-white hover:bg-gray-50 transition-colors">
                <td className="px-4 py-3">
                  ...
                  {ev.subject?.code && <p className="text-xs text-gray-400">{ev.subject.code}</p>}
                </td>
                ...
                <td className="px-4 py-3 text-center">
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${st.bg} ${st.color}`}
                  >
                    {st.label}
                  </span>
                </td>
