        ...
        <div className="max-w-5xl mx-auto px-6 pt-5 pb-0 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-9 h-9 rounded-xl bg-gray-100 border border-gray-200 flex items-center justify-center flex-shrink-0">
              <svg className="w-4.5 h-4.5 text-gray-600" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
            ...
            <div>
              <div className="flex items-center gap-2.5">
                <h1 className="text-base font-bold text-gray-900 tracking-tight" style={{ fontFamily: "'Georgia', serif" }}>
                  Herramientas de práctica
                </h1>
                <span className="hidden sm:inline-flex items-center gap-1 text-[10px] font-semibold text-gray-400 bg-gray-100 border border-gray-200 px-2 py-0.5 rounded-full uppercase tracking-wider">
                  Musical
                </span>
              </div>
              <p className="text-xs text-gray-400 mt-0.5 leading-none">
                Afinador · Metrónomo · Guía de compases
              </p>
            </div>
          </div>
        </div>
